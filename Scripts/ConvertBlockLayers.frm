VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ConvertBlockLayers 
   Caption         =   "Bulk Change Block Layers"
   ClientHeight    =   6000
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   7080
   OleObjectBlob   =   "ConvertBlockLayers.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "ConvertBlockLayers"
...
Private Sub cbUpdate_Click()
    ...
    lbConditions.List(lbConditions.ListCount - 1, 2) = cbToLayer.Value
End Sub
